...
export const recentAdminActivity: ActivityItem[] = [
  ...
  },
  {
    id: "3",
    action: "Assigned",
    entity: "MD26 · Kano Pillars vs Kaduna",
    entityType: "fixture",
  ...
  },
  {
    id: "6",
    action: "Created",
    entity: "Kano State League 2025/26",
    entityType: "league",
  ...
  },
  {
    ...
    entity: "Emeka Okafor",
    entityType: "player",
    time: new Date(n - 1 * 86_400_000 - 1 * 3_600_000),
  },
  {
    id: "9",
    action: "Created",
    entity: "Gombe Bulls FC",
    entityType: "team",
    time: new Date(n - 1 * 86_400_000 - 2 * 3_600_000),
  },
  {
    id: "10",
    action: "Assigned",
    entity: "MD24 · Gombe vs Bauchi",
    entityType: "fixture",
    time: new Date(n - 1 * 86_400_000 - 4 * 3_600_000),
  },
  {
    id: "11",
    action: "Created",
    entity: "Halima Bello (SCR-007)",
    entityType: "agent",
    time: new Date(n - 1 * 86_400_000 - 6 * 3_600_000),
  },
  {
    id: "12",
    action: "Updated",
    entity: "Kaduna Premier League",
    entityType: "league",
    time: new Date(n - 1 * 86_400_000 - 9 * 3_600_000),
  },
  {
    id: "13",
    action: "Deleted",
    entity: "Zamfara Warriors FC",
    entityType: "team",
    time: new Date(n - 2 * 86_400_000 - 2 * 3_600_000),
  },
  {
    id: "14",
    action: "Created",
    entity: "Pantami Stadium",
    entityType: "stadium",
    time: new Date(n - 2 * 86_400_000 - 5 * 3_600_000),
  },
  {
    id: "15",
    action: "Updated",
    entity: "Chukwudi Eze",
    entityType: "player",
    time: new Date(n - 2 * 86_400_000 - 8 * 3_600_000),
  },
  {
    id: "16",
    action: "Assigned",
    entity: "MD22 · Katsina vs Jigawa",
    entityType: "fixture",
    time: new Date(n - 3 * 86_400_000 - 1 * 3_600_000),
  },
  {
    id: "17",
    action: "Created",
    entity: "Jigawa State Cup 2025/26",
    entityType: "league",
    time: new Date(n - 3 * 86_400_000 - 4 * 3_600_000),
  },
  {
    id: "18",
    action: "Updated",
    entity: "Musa Danladi (SCR-011)",
    entityType: "agent",
    time: new Date(n - 4 * 86_400_000 - 2 * 3_600_000),
  },
  {
    id: "19",
    action: "Deleted",
    entity: "Abubakar Sani",
    entityType: "player",
    time: new Date(n - 4 * 86_400_000 - 6 * 3_600_000),
  },
  {
    id: "20",
    action: "Created",
    entity: "Sokoto Rovers",
    entityType: "team",
    time: new Date(n - 5 * 86_400_000 - 3 * 3_600_000),
  },
];
